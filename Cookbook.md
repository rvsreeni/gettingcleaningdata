...
### Tidy Dataset created by run_analysis R script

results.txt - Merged observations from Training, Test datasets, containing mean and standard deviation variables, along with subject and activity

### Varaiables in Tidy dataset 
